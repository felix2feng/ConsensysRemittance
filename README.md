### REMITTANCE
This a smart contract named Remittance whereby:
...
Features:
- Passwords inputs must be hashed
- A deadline, after which Alice can claim back the unchallenged Ether
- Includes a kill switch to the whole contract
- Owner of contract can charge fees